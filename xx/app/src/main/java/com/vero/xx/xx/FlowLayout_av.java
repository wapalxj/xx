...
public class FlowLayout_av extends ViewGroup {
    ...
    public FlowLayout_av(Context context) {
        super(context);
//        initMeasureParams();
    }

    //反射
    public FlowLayout_av(Context context, AttributeSet attrs) {
        super(context, attrs);
//        initMeasureParams();
    }

    //主题style
    public FlowLayout_av(Context context, AttributeSet attrs, int defStyleAttr) {
